...
#  calculates the average of all even numbers between the low and high numbers, and prints both the sum and average of these even numbers using loop.
...
print(f"Average of even numbers between {low} and {high} is: {sum / count}")