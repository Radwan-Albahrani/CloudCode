...
# calculates the average of all odd numbers between the low and high numbers, and prints both the sum and average of these odd numbers using loop.
...
print(f"Number of Odd numbers between {low} and {high} is: {sum / count}")